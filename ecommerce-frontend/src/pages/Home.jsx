  ...
  return (
    <>
      <div className="min-h-screen bg-white">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center px-6 md:px-12 py-8">
              ...
              <div>
                ...
                <p className="mt-6 text-lg text-gray-700 max-w-lg">
                  Explore thousands of products curated for quality,
                  affordability, and everyday convenience.
                </p>
        ...
        <section
          ref={productsRef}
          className="mx-auto px-5 md:px-12 pb-10"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            {error ? (
              <div className="col-span-full text-center py-10">
                ...
                <button
                  onClick={fetchData}
                  className="mt-3 rounded-lg bg-black px-4 py-2 text-sm text-white hover:bg-gray-800"
                >
                  Try Again
                </button>
              </div>
